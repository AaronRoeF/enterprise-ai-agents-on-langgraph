...
This is not a vendor pitch. I run an AI infrastructure company. That company is named once in the author bio and once in `CONFLICTS.md`, and zero times in the body of any tier file. The chapter where a vendor would normally win is the chapter that isn't here. If you're using this for procurement evaluation, please read `CONFLICTS.md` first — it exists for that exact use case.
